...
<%  
	...
	{	 if(sessione_segreteria.getEmail().length()>0)
		 { 
			request.setAttribute("questions_segreteria", tirocinioModel.doRetrieveAllQuestions(""));
			...
			<div class="col-lg-12">
               <div class="panel panel-default">
                   <div class="panel-heading">
                            <h2>Richieste di Tirocinio (<%=questions.size()%>)</h2>
                   </div>
                     <!-- /.panel-heading -->
                        ...
                        if (questions != null && questions.size() != 0) {
                           ...
                           <%
							...
							{%>
								Nessun Richiesta di Tirocinio trovata.
